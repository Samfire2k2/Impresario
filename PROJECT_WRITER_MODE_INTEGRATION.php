...
<?php
// Writer Mode is now always activated - all users are writers!
?>

<div class="writer-mode-toolbar">
    <span class="writer-toolbar-title">✍️ Mode Écrivain</span>
    <div class="writer-toolbar-links">
        <a href="dashboard.php?view=writer&project=<?php echo $projectId; ?>" class="writer-toolbar-link" title="Dashboard avec statistiques">
            📊 Dashboard
        </a>
