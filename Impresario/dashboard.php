...
// Vérifier si Writer Mode est activé
$writerModeCheck = $pdo->query("SELECT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_name = 'element' AND column_name = 'content') AS writer_mode_active");
$writerModeResult = $writerModeCheck->fetch(PDO::FETCH_ASSOC);
$writerModeActive = $writerModeResult ? $writerModeResult['writer_mode_active'] : false;
...
<body>
    ...
    <main class="dashboard">
        <div class="dashboard-container">
            ...
            <!-- Writer Mode Activation Banner -->
            <?php if (!$writerModeActive): ?>
                <div class="writer-mode-banner">
                    <div class="banner-content">
                        <h3>✨ Débloquez le Mode Écrivain</h3>
                        <p>Accédez à des outils professionnels : éditeur WYSIWYG, gestion de personnages, comptage de mots, et exportation en PDF/DOCX.</p>
                        <a href="setup-writer.php" class="btn btn-primary">🚀 Activer Writer Mode</a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <section class="projects-grid">
                ...
                <?php else: ?>
                    <?php foreach ($projects as $project): ?>
                        <div class="project-card" data-project-id="<?php echo $project['id']; ?>" style="cursor: pointer;">
